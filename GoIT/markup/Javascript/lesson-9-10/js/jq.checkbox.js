$(function() {
console.log("jq.checkbox started");
...
// новый чекбокс выглядит так 
//  <span class="niceCheck">
//    <input type="checkbox" name="[name check]" id="[id check]" [checked="checked"] />
//  </span>
...
function changeCheckStart(el) {
  try {
    ...
    // если ошибка пишем об этом в консоль и віводим стектрейс ексепшна    
    console.log("exeption occured in jq.checkbox.js");
    console.log(e);
  }
  return true;
}
